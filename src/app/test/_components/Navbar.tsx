...
const Navbar = ({ setIsOpen }: NavbarProps) => {
  ...
  return (
    <header className="sticky right-0 top-0 z-50 w-full border-b bg-white">
      <div className="sticky top-0 z-20 flex h-[80px] w-full items-center gap-5 px-1 md:px-10">
